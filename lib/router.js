...
// 中国美术家协会展览通知
router.get('/artexhibition/caanet', require('./routes/caanet/zhanxun'));

// 中国美术学院博士招生信息
router.get('/caaedu/phdadmission', require('./routes/universities/caa/admission'));

// 南京师范大学博士招生信息
router.get('/nnuedu/phdadmission', require('./routes/universities/nnu/admission'));

// 南京艺术学院博士招生信息
router.get('/nua/phdadmission', require('./routes/universities/nua/admission'));

// 南京艺术学院研究生培养工作
router.get('/nua/timetable', require('./routes/universities/nua/timetable'));

// 南京艺术学院研究生学位工作
router.get('/nua/degree', require('./routes/universities/nua/degree'));

// 华东师范大学博士招生信息
router.get('/ecnu/phdadmission', require('./routes/universities/ecnu/admission'));

// 西安美术学院博士招生简章
router.get('/xafa/phdadmission', require('./routes/universities/xafa/admission'));
